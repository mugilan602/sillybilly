    ...
    return (
        <div className="relative w-full mx-auto sm:p-4 rounded-lg text-center">
            ...
            <div
                ...
                className=" bg-[#E0BE9A] w-full sm:w-9/12 mx-auto mt-2 sm:mt-0 sm:relative sm:bottom-6 bg-opacity-75 text-[#404040] text-lg sm:text-lg font-thin p-3 shadow-md">

                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col mx-auto sm:w-8/12 justify-end">
                        ...
                        >
                            ...
                            <img
                                ...
                                alt="button2"
                                className="absolute left-7 inset-0 transition-opacity duration-300 opacity-100 hover:opacity-0"
                            />
                            ...
                            <img
                                ...
                                alt="button2-hover"
                                className="absolute left-7 inset-0 transition-opacity duration-300 opacity-0 hover:opacity-100"
                            />
                        </div>

...
const NetherlandDwarf = () => {
    ...
    useEffect(() => {
        async function fetchBunnyData() {
            console.log("📡 Fetching Netherland Dwarf data from /data/breeds/netherland_dwarf.json...");

            try {
                const response = await fetch("/data/breeds/netherland_dwarf.json");
                ...
                console.error("❌ Error fetching Netherland Dwarf data:", error.message);
            }
        }
    ...
    return (
        <div className="relative p-3 lg:p-6 bg-[#FFF8F1] min-h-screen">
            ...
            {/* Header */}
            <div className="my-4">
                <h2 style={{ fontFamily: "Cookie, cursive" }} className="text-3xl sm:text-4xl text-center mb-8 text-[#A2672D]">
                    Here are a few of our babies currently available for reservation.
                </h2>
                <p style={{ fontFamily: "Futura LT Book" }} className="text-center text-xl text-[#404040] mb-8">
...
export default NetherlandDwarf;

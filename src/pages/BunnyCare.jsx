    ...
    return (
        <>
            <div className="relative lg:bg-[#E0BE9A] w-full flex flex-col items-center justify-end">
                ...
                <div
                    className="hidden lg:block lg:mb-20 absolute inset-0 bg-cover bg-center bg-no-repeat"
                ...
                {/* Content Box */}
                <div className="relative mt-5 lg:mt-20 z-10 max-w-4xl w-11/12 bg-white bg-opacity-90 p-2 sm:p-10 text-center lg:bottom-0">
